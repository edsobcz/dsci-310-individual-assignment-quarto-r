...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-horsepops width=80%}
...
Additionally, note that in @tbl-std we consider the sample standard deviation of the number of horses during the same time span as @fig-horsepops.

![Horse populations for the province with the largest standard deviation](../results/horse_pop_plot_largest_sd.png){#fig-horsestd width=60%}

In @fig-horsestd we zoom in and look at the province of `{r} largest_sd`, which had the largest spread of values in terms of standard deviation.
